...
void DockingHelper::SetupDefaultLayout(ImGuiID dockspace_id,
                                       const ImVec2& size) {
    ...
    // Split the dockspace: left side for Editor Panel (30% width), right for
    // Scene View
    ImGuiID dock_left_id = 0;
    ImGuiID dock_right_id = 0;
    ImGui::DockBuilderSplitNode(
        dockspace_id, ImGuiDir_Left, 0.30f, &dock_left_id, &dock_right_id);
