...
class TilePanel {
 public:
    ...
    inline PlatformBehaviorType get_platform_behavior() const noexcept { return platform_behavior; }
    ...
    // Platform editing
    void set_selected_platform(EditorPlatform* platform) { selected_platform_ = platform; }
